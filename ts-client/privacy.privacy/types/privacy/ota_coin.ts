...
export interface OTACoin {
  index: string;
  outputCoinIndex: string;
  height: Uint8Array;
}

const baseOTACoin: object = { index: "", outputCoinIndex: "" };
...
export const OTACoin = {
  encode(message: OTACoin, writer: Writer = Writer.create()): Writer {
    ...
    if (message.outputCoinIndex !== "") {
      writer.uint32(18).string(message.outputCoinIndex);
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.outputCoinIndex = reader.string();
          break;
        case 3:
  ...
  fromJSON(object: any): OTACoin {
    ...
    if (
      object.outputCoinIndex !== undefined &&
      object.outputCoinIndex !== null
    ) {
      message.outputCoinIndex = String(object.outputCoinIndex);
    } else {
      message.outputCoinIndex = "";
    }
  ...
  toJSON(message: OTACoin): unknown {
    ...
    message.outputCoinIndex !== undefined &&
      (obj.outputCoinIndex = message.outputCoinIndex);
  ...
  fromPartial(object: DeepPartial<OTACoin>): OTACoin {
    ...
    if (
      ...
      message.outputCoinIndex = object.outputCoinIndex;
    } else {
      message.outputCoinIndex = "";
    }
    if (object.height !== undefined && object.height !== null) {
