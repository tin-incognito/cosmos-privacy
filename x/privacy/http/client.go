...
func (c *Client) OutputCoinSerialNumber() (*types.OutputCoinSerialNumber, error) {
	...
	type Result struct {
		OutputCoinSerialNumber *types.OutputCoinSerialNumber `json:"OutputCoinSerialNumber"`
	}
	var temp Result
	err = json.Unmarshal(body, &temp)
	if err != nil {
